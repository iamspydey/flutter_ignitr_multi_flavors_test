...
class LoginController extends AppController {
  ...
  final TextEditingController identifierInput = TextEditingController(text: "shoaib.khan@devsbuddy.com");
  final TextEditingController passwordInput = TextEditingController(text: "password");
